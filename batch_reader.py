...
class Batcher(object):
  ...
  def _FillInputQueue(self):
    ...
    while True:
      ...
      #tf.logging.warning('_FillInputQueue. Article_sentences:%s', article_sentences)
      #tf.logging.warning('_FillInputQueue. Abstract_sentences:%s', abstract_sentences)
      enc_inputs = []
